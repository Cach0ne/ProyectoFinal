	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarButtonsExample">
			...
			<a class="btn btn-outline-success me-3"
				...
				href="./Turnos.jsp?dni=<%out.println(dni);%>">TURNOS</a> <a
...
<body>
	...
	<section id="BG_Turnos"
		class="d-flex justify-content-center bg-grayish">
								...
								<tbody>
									<tr>
										...
										<td>
											<p>
												<abbr title="QUITAR"><a
													class="btn btn-link btn-md px-3" style="color: red"
													data-ripple-color="dark"
													href="../controller/QuitarTurnoController.jsp?dni=<%=dni%>&id=<%=turno.getId()%>"
													role="buttom"> <i class="fas fa-trash-alt"></i>
												</a></abbr>
											</p>
										</td>
									</tr>
